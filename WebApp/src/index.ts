    ...
    const readOptions = (): Options => {
      if (Array.isArray(argv)) {
        program
          ...
          .option('-ca, --cafile <path>', 'https ca-bundle file (default server.ca-bundle)', process.env.CABUNDLE || 'server.ca-bundle')
          ...
          .option('-g, --eagleEyeLogDir <path>', 'Directory where eagle eye log shall be stored.', path.join(process.env.APPDATA, "../LocalLow/TWST/EE Unity Project"))
